...
const recipientEmail = "guymorganb@gmail.com";
    ...
    const bg = useColorModeValue("#b2bec3", "#2d3748")
    ...
    return (
      <Center display="flex" flexDirection="column" h='auto'>
        <Box
          ...
          bg={bg}
        >
          <Heading as="h2" size="lg">Level Up Apps & Software LLC</Heading>
          <Text mt={2}><strong>Name:</strong> Guy Morgan B</Text>
          <Text><strong>Email:</strong> info@levelupco.com</Text>
          <Text><strong>Mailing Address:</strong>Avaliabe upon request</Text>
        </Box>
        <Box
           ref={contactBoxRef}
           ...
           mt="4%"                 //<-- Move form up
           transform={`perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) rotateZ(${rotateY}deg)`}//<-- Add 3D rotation on the Box
